...
public class SymbolPointLibrary extends SymbolLibrary
{
  static final private String[] DefaultPoints = {
    ...
    POPCORN, "raft-cone", ROOT, SAND, SECTION, SLOPE, SNOW, SODA_STRAW, STALACTITE, "stalactite:alternate",
    STALAGMITE, "stalagmite:alternate", WATER_FLOW
  };
  ...
  static final private String p_reference = "moveTo -6 -4 lineTo 6 -4 lineTo 6 4 lineTo -6 4 lineTo -6 -4 moveTo -2 -1 lineTo 1 -1 lineTo 3 1 lineTo 4 -2 lineTo 6 2";
