...
public class TDsafUri
{
  ...
  static public ParcelFileDescriptor docWriteFileDescriptor( Uri uri )
  {
    if ( uri != null ) {
      try {
        return TDInstance.getContentResolver().openFileDescriptor( uri, "wt" ); // FIXME because "wt" is not documented
      } catch ( IOException e ) {
        e.printStackTrace();
      }
    }
  ...
  /** return the user-visible name of a document URI
  ...
  static String selectDocumentName( String display_name, String path_name )
  {
