...
// TODO new formulation of leys
  ...
  static TDPrefKey[] mPlot = {
    ...
    new TDPrefKey( D, LONG, UI,  "DISTOX_TOOLBAR_SLOTS",  R.string.pref_toolbarSlots_title,  R.string.pref_toolbarSlots_summary,  "8" ),
    new TDPrefKey( D, LONG, UI,  "DISTOX_TOOLBAR_ROWS",   R.string.pref_toolbarRows_title,   R.string.pref_toolbarRows_summary,   TDString.TWO ),
  ...
  static TDPrefKey[] mGeekPlot = {
    ...
    new TDPrefKey( D,       UI,  "DISTOX_TOOLBAR_UPDATE",   R.string.pref_toolbar_update_title,    R.string.pref_toolbar_update_summary,    "3", R.array.toolbarUpdate, R.array.toolbarUpdateValue )
  };
