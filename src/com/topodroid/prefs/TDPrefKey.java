...
// TODO new formulation of leys
  ...
  static TDPrefKey[] mPlot = {
    ...
    new TDPrefKey( B, LONG, UI,  "DISTOX_TOOLBAR_ROWS",   R.string.pref_toolbarRows_title,   R.string.pref_toolbarRows_summary,   TDString.ONE ),
  ...
  static TDPrefKey[] mLine = {
    ...
    new TDPrefKey( N, FLT,  UI, "DISTOX_USER_LINE_FINE_WIDTH",     R.string.pref_sketch_line_fine_width_title,     R.string.pref_sketch_line_fine_width_summary,     TDString.ONE ),
    new TDPrefKey( N, COL,  UI, "DISTOX_USER_LINE_FINE_COLOR",     R.string.pref_sketch_line_fine_color_title,     R.string.pref_sketch_line_fine_color_summary,     "16777215" ),
    new TDPrefKey( N, FLT,  UI, "DISTOX_USER_LINE_STANDARD_WIDTH", R.string.pref_sketch_line_standard_width_title, R.string.pref_sketch_line_standard_width_summary, TDString.TWO ),
    new TDPrefKey( N, COL,  UI, "DISTOX_USER_LINE_STANDARD_COLOR", R.string.pref_sketch_line_standard_color_title, R.string.pref_sketch_line_standard_color_summary, "16777215" ),
    new TDPrefKey( N, FLT,  UI, "DISTOX_USER_LINE_THICK_WIDTH",    R.string.pref_sketch_line_thick_width_title,    R.string.pref_sketch_line_thick_width_summary,    TDString.FIVE ),
    new TDPrefKey( N, COL,  UI, "DISTOX_USER_LINE_THICK_COLOR",    R.string.pref_sketch_line_thick_color_title,    R.string.pref_sketch_line_thick_color_summary,    "16777215" ),
    ...
    new TDPrefKey( N, BOOL, UI, "DISTOX_FIXED_LINE_PATTERNS", R.string.pref_fixed_line_patterns_title, R.string.pref_fixed_line_patterns_summary, TRUE )
  };
  ...
  static TDPrefKey[] mSPen = {
    ...
    new TDPrefKey( B, UI, "DISTOX_ACTIVE_KEY_SINGLE_PRESS", R.string.pref_active_key_single_press_title, R.string.pref_active_key_single_press_summary, "6",           R.array.spenActions, R.array.spenActionsValue ),
    new TDPrefKey( B, UI, "DISTOX_ACTIVE_KEY_LONG_PRESS",   R.string.pref_active_key_long_press_title,   R.string.pref_active_key_long_press_summary,   "3",           R.array.spenActions, R.array.spenActionsValue ),
    new TDPrefKey( B, UI, "DISTOX_ACTIVE_KEY_DOUBLE_PRESS", R.string.pref_active_key_double_press_title, R.string.pref_active_key_double_press_summary, "5",           R.array.spenActions, R.array.spenActionsValue ),
