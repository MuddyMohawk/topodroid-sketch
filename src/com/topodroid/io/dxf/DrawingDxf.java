...
*/
	...
	String scale_len = TDString.TWENTY;
	  ...
	  // offset axes legends by 1
        ...
        for ( ICanvasCommand cmd : plot.getCommands() ) {
		  ...
		  DXF.printFloat( pw5, 41, point.getScaleValue()*TDSetting.pointInkUnit()); //HBX unit
                  DXF.printFloat( pw5, 42, point.getScaleValue()*TDSetting.pointInkUnit()); //HBX unit
  ...
  { // FIXME point scale factor is 0.3
    ...
    DXF.printFloat( pw, 41, point.getScaleValue()*TDSetting.pointInkUnit()); //HBX unit
